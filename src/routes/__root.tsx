...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Charan Tallolli — AI Developer & SDET" },
      { name: "description", content: "Portfolio of Charan Tallolli — AI / ML developer, automation test engineer and full-stack builder." },
      { name: "author", content: "Charan Tallolli" },
